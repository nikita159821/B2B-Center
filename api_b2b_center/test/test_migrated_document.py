...
from api_b2b_center.test.data import EXPECTED_RESPONSE_BODY_MIGRATE_CHILD_DOCUMENT_PAYLOAD, \
    EXPECTED_RESPONSE_BODY_DOCUMENT_ALREADY_EXISTS_PAYLOAD, EXPECTED_RESPONSE_BODY_MIGRATE_CHILD_DOCUMENT, \
    EXPECTED_RESPONSE_BODY_DOCUMENT_ALREADY_EXISTS, EXPECTED_RESPONSE_BODY_SUPPLIER_NOT_FOUND_PAYLOAD, \
    ...
    EXPECTED_RESPONSE_BODY_ACCOUNT_DETAILS_ID_REQUIRED, EXPECTED_RESPONSE_BODY_INSUFFICIENT_PRIVILEGES, \
    EXPECTED_RESPONSE_BODY_INSUFFICIENT_PRIVILEGES_PAYLOAD, EXPECTED_RESPONSE_BODY_VALIDITY_START_DATE_REQUIRED_PAYLOAD, \
    ...
    EXPECTED_RESPONSE_BODY_LOAD_CATALOG_INVALID_PAYLOAD, EXPECTED_RESPONSE_BODY_RCM_SIGN_PLACE_REQUIRED, \
    EXPECTED_RESPONSE_BODY_LOAD_CATALOG_INVALID, EXPECTED_RESPONSE_BODY_CURRENCY_CODE_REQUIRED_PAYLOAD, \
